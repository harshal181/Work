...
void treatment(){
System.out.println("provide best treatment");
}
}
...
void treatment(){
System.out.println("provide best Surgery treatment");
}
}
...
void treatment(){
System.out.println("provide best Theropy  treatment");
}
}
...
class TestDoctor {
    public static void main(String[] args) {
        ...
        Doctor d1;
         ...
         d1 = new Surgeon("Dr. Smith", 45, "Surgery", 150000.0, 120, true);  
         d1.display();
         d1.treatment();                      
         d1 = new  TherapyDoctor("Dr. Emma", 38, "Therapy", 90000.0, 60, "Occupational");
        d1.display();
        d1.treatment();
