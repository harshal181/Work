...
void use(){
System.out.println("general medicine are use");
}
...
void use(){
 System.out.println("Tablets are used for regular dosage and oral consumption.");
}
}
...
void use(){
 System.out.println("Syrup is used for children and liquid dosage.");
}
}
...
void use(){
System.out.println("Injection is used for fast relief and emergency treatment.");
}
