...
Piano p1=new Piano("Piano","Tata","Keyboard",45,550.0,12,true);
p1.display();
Guitar g1=new Guitar("Guitar","Adani","String",48,622.0,49,true);
g1.display();

Flute f1=new Flute("Flute","Ambani","Wind",23,23.4,"wood",12);
f1.display();
}
}
