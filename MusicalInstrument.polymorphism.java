...
void play(){
System.out.println("playing a generetic musical instrument");
}
}
...
void play(){
System.out.println("playing the piano keys melodiously..");
}
}
...
void play(){
System.out.println("struming the guitar string");
}
}
...
void play(){
System.out.println("Blowing air into the flute to create soft notes..");
}
}
...
m1=new MusicalInstrument("Musical Instrument","Jio","All",22,23.0);
m1.display();
m1.play();
