...
class MathTeacher extends Teacher {
    ...
    void setUsesTechnology(boolean t) {
        this.usesTechnology = t;
    }
    ...
    boolean getUsesTechnology() {
        return this.usesTechnology;
    }
...
class PhysicsTeacher extends Teacher {
    ...
    void setHasLab(boolean l) {
        this.hasLab = l;
    }

    void setNumberOfExperiments(int e) {
        this.numberOfExperiments = e;
    }
...
class ScienceTeacher extends Teacher {
    ...
    void setConductsFieldTrips(boolean ft) {
    ...
    boolean getConductsFieldTrips() {
        return this.conductsFieldTrips;
    }
 ...
 class TestTeacher{
    public static void main(String[] args) {
        ...
        MathTeacher m2 = new MathTeacher("Alice", 35, "Mathematics", 50000.0, 40, true);

        PhysicsTeacher p1 = new PhysicsTeacher();
        PhysicsTeacher p2 = new PhysicsTeacher("Bob", 40, "Physics", 55000.0, true, 15);

        ScienceTeacher s1 = new ScienceTeacher();
        ScienceTeacher s2 = new ScienceTeacher("Clara", 38, "Science", 52000.0, "Biology", true);
